        ...
        <article class="article-item">
            ...
            <div class="post_conter">
                ...
                <div class="post_info_footer">
                    <?php $this->sticky(); ?>
                    <span class="view"><a href="<?php $this->permalink() ?>" alt="<?php get_post_view($this) ?>人阅读过<?php $this->title() ?>"><?php get_post_view($this) ?> 阅读</a></span>
                    ...
                    <span>
                        ...
                        <a href="javascript:;" data-action="ding" data-id="<?php $this->cid(); ?>" class="post_like">
                            <b class="count"><?php echo $likes; ?></b> 赞
                        </a>
                    </span>
                </div>
            </div>
